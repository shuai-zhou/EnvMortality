...
// *==========================================================
// log close _all
// log using "$results/figure_3.log", replace

// *==========================================================
// * plot chronic respiratory marginal plot
// *==========================================================
// ** 0_1
...
// graph save "$results/mrgsplot_cr_0_1.gph", replace
...
// gr_edit plotregion1.subtitle[1].style.editstyle fillcolor(gs12)
// gr_edit plotregion1.title[2].draw_view.setstyle, style(no)
// graph save "$results/mrgsplot_cr_1_14.gph", replace
...
//     plot2opts(lcolor(blue) lpattern(dash_dot)) ci2opts(color(blue%20)) /// pm2.5 = 10 medium
//     plot3opts(lcolor(red) lpattern(longdash)) ci3opts(color(red%20)) /// pm2.5 = 15 high
// 	name(mrgsplot_cr_15_64, replace) ///
// 	title("c)", placement(w)) ///
// 	ytitle("Mortality per 100,000 persons") xtitle("Temperature (°C)") ///
// 	xlabel(0 "0" 5 "5" 10 "10" 15 "15" 20 "20" 26 "26")
// gr_edit title.draw_view.setstyle, style(no)
...
// gr_edit plotregion1.subtitle[1].style.editstyle fillcolor(gs12)
// gr_edit plotregion1.title[2].draw_view.setstyle, style(no)
// graph save "$results/mrgsplot_cr_15_64.gph", replace
...
// gr_edit plotregion1.subtitle[1].style.editstyle fillcolor(gs12)
// gr_edit plotregion1.title[2].draw_view.setstyle, style(no)
// graph save "$results/mrgsplot_cr_65.gph", replace

*==========================================================
* combine chronic respiratory marginal plot
*==========================================================
grc1leg2 ///
    "$results/mrgsplot_cr_0_1.gph" ///
    "$results/mrgsplot_cr_1_14.gph" ///
    "$results/mrgsplot_cr_15_64.gph" ///
    "$results/mrgsplot_cr_65.gph", ///
    legendfrom("$results/mrgsplot_cr_0_1.gph") ///
...
graph export "$results/figure_3.png", width(1000) height(800) replace
