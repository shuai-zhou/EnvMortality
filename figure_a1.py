...
# # prepare data
# #================================================================
# ## county-level temperature data
# cus = gpd.read_file('./data/county_cus.zip')
# cus.crs

# df = pd.read_stata('./data/county_tmax.dta')
# df.shape
# cus_merge = cus.merge(df, on='countyfips')
# cus_merge.shape
# cus_merge.head()
# cus_merge.rename(columns={'band_data': 'tmax'}, inplace=True)
# cus_merge.head()
# cus_merge = cus_merge.drop(['index', 'area_sqkm', 'area_sqmi'], axis=1)
# cus_merge.head()
# cus_merge.to_file('./data/cus_tmax_epsg_2163.shp')

# ## gridded temperature data
# ds = xr.open_dataset('./data/PRISM_tmax_stable_4kmD2_20200731_bil.bil', engine='rasterio')
# ds
# ds['band_data'].plot()

# ds = ds.rename({'band_data': 'tmax'})
# ds

# da_tmax = ds.tmax
# da_tmax
# da_tmax.rio.write_crs('epsg:4326', inplace=True)
# da_tmax.plot()
# da_tmax_2163 = da_tmax.rio.reproject('epsg:2163')
# da_tmax_2163.plot()
# da_tmax_2163.to_netcdf('./data/grid_tmax_epsg_2163.nc')
